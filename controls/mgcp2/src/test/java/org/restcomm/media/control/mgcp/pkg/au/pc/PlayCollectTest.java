...
public class PlayCollectTest {
    ...
    public void testCollectOneDigitWithEndInputKey() throws InterruptedException {
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "5", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "#", -30));
    ...
    public void testCollectWithReinputKeyAndEndInputKey() throws InterruptedException {
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "1", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "2", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "3", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "A", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "4", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "5", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "6", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "#", -30));
    ...
    public void testSuccessfulCollectWithDigitPatternOfAtLeastOneDigitFollowedByTwoDistinctLetters()
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "5", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "A", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "B", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "#", -30));
    ...
    public void testSuccessfulCollectWithDigitPatternOfNineFollowedByAnyDigitFollowedByOptionalLetter()
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "9", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "1", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "#", -30));
    ...
    public void testSuccessfulCollectWithTwoDigitPatterns() throws InterruptedException {
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "9", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "A", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "C", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "#", -30));
    ...
    public void testPlayCollectFirstDigitTimeout() throws InterruptedException {
        ...
        pc.getPlayerListener().process(new AudioPlayerEvent(player, AudioPlayerEvent.STOP));
        Thread.sleep(6 * 100);
    ...
    public void testInitialPromptWithMultipleSegments()
        ...
        Thread.sleep(5);
        pc.getPlayerListener().process(new AudioPlayerEvent(player, PlayerEvent.STOP));
        Thread.sleep(5);
        pc.getPlayerListener().process(new AudioPlayerEvent(player, PlayerEvent.STOP));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "9", -30));
    ...
    public void testCancelWhenCollectingAndDigitPatternDidNotMatch()
        ...
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "B", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "C", -30));
        pc.getDetectorListener().process(new DtmfEventImpl(detector, "D", -30));
        pc.cancel();
